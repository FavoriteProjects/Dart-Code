...
export class FlutterDebugSession extends DartDebugSession {
	...
	protected spawnRunDaemon(isAttach: boolean, args: FlutterLaunchRequestArguments, logger: Logger): RunDaemonBase {
		...
		return new FlutterRun(isAttach ? RunMode.Attach : RunMode.Run, args.flutterPath, args.flutterCustomRunScript, args.globalFlutterArgs || [], args.cwd, appArgs, { envOverrides: args.env, toolEnv: this.toolEnv }, args.flutterRunLogFile, logger, this.maxLogLineLength);
	}
