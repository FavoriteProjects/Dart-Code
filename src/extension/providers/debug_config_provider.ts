...
export class DebugConfigProvider implements DebugConfigurationProvider {
	...
	constructor(private readonly logger: Logger, private readonly workspaceContext: WorkspaceContext, private readonly analytics: Analytics, private readonly pubGlobal: PubGlobal, private readonly daemon: IFlutterDaemon, private readonly deviceManager: FlutterDeviceManager, private dartCapabilities: DartCapabilities, private readonly flutterCapabilities: FlutterCapabilities) { }
	...
	private setupDebugConfig(folder: WorkspaceFolder | undefined, debugConfig: FlutterLaunchRequestArguments, isFlutter: boolean, device: Device | undefined, deviceManager: FlutterDeviceManager) {
		...
		debugConfig.dartPath = debugConfig.dartPath || path.join(this.workspaceContext.sdks.dart!, dartVMPath);
		...
		debugConfig.pubPath = debugConfig.pubPath || path.join(this.workspaceContext.sdks.dart!, pubPath);
		debugConfig.pubSnapshotPath = debugConfig.pubSnapshotPath || path.join(this.workspaceContext.sdks.dart!, pubSnapshotPath);
		...
		if (isFlutter && this.workspaceContext.sdks.flutter) {
